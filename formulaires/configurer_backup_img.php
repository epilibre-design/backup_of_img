...
function formulaires_configurer_backup_img_charger_dist(): array
{
    return [
        ...
        'cron_heure'          => lire_config('backup_img/cron_heure',          '0'),
        'cron_jour_semaine'   => lire_config('backup_img/cron_jour_semaine',   '1'),
        'cron_jour_mois'      => lire_config('backup_img/cron_jour_mois',      '1'),
